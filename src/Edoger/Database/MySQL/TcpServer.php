...
class TcpServer extends Server
{
     ...
     * @return void
     */
    public function __construct(string $name, string $username = 'root', string $password = '', string $host = '127.0.0.1', int $port = 3306, string $dbname = '', string $charset = 'utf8mb4')
    {
        parent::__construct($name, $username, $password, $host, $port, '', $dbname, $charset);
    }
}
